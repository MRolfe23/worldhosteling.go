...
public class Hostel {
    ...
    @NotNull(message = "Must include a country.")
    private String country;

    @Column(nullable = false)
    @NotNull(message = "Must include a city.")
    private String city;

    private String region;

    @Column(nullable = false)
    @NotNull(message = "Must include a description.")
    ...
    @Column(nullable = false)
    @NotNull(message = "Must include a price.")
    ...
    @Column(nullable = false)
    @NotNull(message = "Must include a hostel name.")
    private String name;
